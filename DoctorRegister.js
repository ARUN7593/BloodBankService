...
mainSection.setAttribute("style","display:flex");
    ...
    h3.textContent="Doctor Register Page";
    form.appendChild(h3);
    ...
    form.appendChild(label4);
        ...
        input41.setAttribute("class","male");
        ...
        input42.setAttribute("required", "true");
        label42.innerText="FEMALE";
        input42.setAttribute("class","female");
        input41.setAttribute("id","female");
    ...
    input5.setAttribute("id","degree");
    input5.setAttribute("name","degree");
    input5.setAttribute("required","true");
    input5.setAttribute("style", "margin-top:20px;margin-left:20px;");
    // input5.textContent="select value";
    // input5.setAttribute("value","select degree");
    // input5.textContent="MBBS";
    // input5.setAttribute("value","MBBS");
    // input5.textContent="MDS";
    // input5.setAttribute("value","MDS");

    let degreeArray=["Select Degree","MBBS","MDS","BDS"];
    let selectText=["Select Degree","MBBS","MDS","BDS"];
    
    for(let i=0;i<=degreeArray.length;i++)
    {
         let option1 = document.createElement("option");
         option1.setAttribute("style", "margin-top:20px;margin-left:20px;");
         option1.setAttribute("id","degree");
         option1.setAttribute("name","degree");
         //option1.setAttribute("required", "required");
         option1.textContent=degreeArray[i];
         option1.value=selectText[i];//.value;
    ...
    { 
        ...
        divg1.setAttribute("style","border: 1px solid black;width:600px;height:500px;color:black;background-color: lightgreen;margin-left:200px");
            ...
            h2.textContent=" Successfully generated DOCTOR id";
            ...
            para.innerHTML="As Per the records the DOCTOR ID is <h3>DOCID"+getRandom(1200,5000)+"<h3>";
        ...
        let tr2=document.createElement("tr");
            ...
            td21.setAttribute("style","border:1px solid black;padding:10px");
            td21.append(document.getElementById("fullname").value);
            let td22=document.createElement("th");
            td22.setAttribute("style","border:1px solid black;padding:10px");
            td22.append(document.getElementById("username").value);
            let td23=document.createElement("th");
            td23.setAttribute("style","border:1px solid black;padding:10px");
            td23.append(document.getElementById("password").value);
            let td24=document.createElement("th");
            td24.setAttribute("style","border:1px solid black;padding:10px");
           // td24.append(document.getElementById("gender").value);
            let td25=document.createElement("th");
            td25.setAttribute("style","border:1px solid black;padding:10px");
            //td25.append(document.getElementById("degree").value);
            let td26=document.createElement("th");
            td26.setAttribute("style","border:1px solid black;padding:10px");
            //td26.append(document.getElementById("duty").value);
    ...
    function formValidation()
    {
        ...
        //var female = document.registration.gender;
        var udeg = document.registration.degree;
        var uduty = document.registration.duty;
        ...
        if(fullname_validation(fname,5,12))
        {
            if(username_validation(uname,7,12))
            {
                if(userpass_validation(upass,7,12))  
                {
                    ...
                    //{
                        if(gender_validation(gender))//if(alphanumeric(uadd))
                        { 
                            if(degree_validation(udeg))
                            {
                                if(duty_validation(uduty))
                                {
    ...
    function gender_validation()
    {
        ...
        if(!male.checked && !female.checked)
        {
            ...
            document.getElementById("span4").innerHTML="Please select gender";
            document.getElementById("span4").style.color="red";    
        }
        else
        {
            //setTimeout(alert('Form submitted!'),3000)
            document.getElementById("span4").innerHTML="valid";
            document.getElementById("span4").style.color="green";    
        }
    }
   
    function degree_validation()
    {
        //var udegree = document.registration.udeg;
        //var udegree_len = udegree.value;

        if(udeg.degreeArray.selectedIndex)
        {
            var sel = document.getElementById("degree");
            //get the selected option
            var selectedText = sel.options[sel.selectedIndex].text;
            document.getElementById('span5').innerHTML = selectedText+"Valid";
        ...
        {
            document.getElementById('span5').innerHTML = "Please select one option";
    ...
    function duty_validation()
    {
       // var uduty = document.registration.duty;
        ...
        {
            x++;
            document.getElementById('span6').innerHTML = "Valid";
            document.getElementById('span6').style.color="green";
            udeg.focus();
        }
        if (uduty_len == 0)
        {
            document.getElementById('span6').innerHTML = " Please select atleast one";
