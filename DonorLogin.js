...
mainSection.style="background-image:url('https://thumbs.dreamstime.com/b/medical-heart-beat-pulse-flat-white-red-hearts-pattern-background-abstract-healthcare-world-blood-donor-day-medical-heart-188609233.jpg?w=1092');background-repeat:no-repeat;width:1200px;height:650px;backgroud-position:cover";
    let form = document.createElement("form");
    form.setAttribute("action", "DonorAgreementDeal.html");
    form.name="loginpage";
    form.setAttribute("style", "margin-top:160px;margin-left:450px;");
    let h3=document.createElement("h3");
    h3.textContent="Donor Login Page";
    ...
    function userpass_validation()
    {
        ...
        if (upass_len == 0 || upass_len >= 12 || upass_len < 7)
        {
            ...
            function alerting()
            {
                ...
                window.location.href = "DonorAgreementDeal.html";
            }
        }
    }
