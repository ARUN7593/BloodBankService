...
mainSection.setAttribute("style","display:flex");
    ...
    h3.textContent="Donor Register Page";
    form.appendChild(h3);
    ...
    form.appendChild(br6);
        ...
        { 
            ...
            divg1.setAttribute("style","border: 1px solid black;width:600px;height:500px;color:black;background-color: lightgreen;margin-left:200px");
                ...
                h2.textContent=" Successfully generated DONOR id";
                ...
                para.innerHTML="As Per the records the DONOR ID is <h3>DONID"+getRandom(1200,5000)+"<h3>";
    ...
    */
    function validsex(umsex,ufsex)
    {
        ...
        if(x==0)
        {
            ...
            document.getElementById('span5').innerHTML = "Select atleast one";
   ...
   /* function address_validation()
    ...
    function duty_validation(ipward,opward)
    {
        var uipward = document.registration.ipward;
        var uopward = document.registration.opward;
       // var uduty_len = uduty.value;
        ...
        if (uduty_len == 0)
        {
            ...
            document.getElementById('span7').innerHTML = "Select atlest one";
            udeg.focus();
            return false;
        }
        else
