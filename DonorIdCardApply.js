...
mainSection.style='display:flex';
    let div1=document.createElement("div");
        ...
        h3.textContent="Donor ID Application";
    ...
    form.appendChild(input7);
        ...
        button1.setAttribute("onclick", "donorIdCardSubmit()");
...
function previewFunction()
{
    ...
    document.getElementById("spanname").innerHTML=donorName;
